 ...
 *     codes changes in future.
	...
	public static final int NOT_AN_SC = 1;
	...
	public void sendError(int sc) {
		...
		setContent(errorBytes);
		
		setContentType(MIMETyper.createInstance().getContentTypeFor(errorHTML));
		
		log.finest("Sent an error response: " + getStatus());
